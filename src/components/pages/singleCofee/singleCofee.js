...
// import './singleCofee.css';

// const SingleCoffee = () => {
//     const {cofeeId} = useParams();
...
//     useEffect(() => {
//         setCoffee(coffeeList[0])
//     }, [])

//     console.log(coffee)
    
//     const content = <View coffee={coffee}/>;
...
//                     <p className="single-comic__descr">{ingredients}</p> 
                    
//                 </div>
//                 <Link to = '/catalog' className="single-comic__back">Back to all</Link>
//             </div>
